...
interface FormAnswerRepository {
    ...
    suspend fun getSessionScopedFormAnswers(sessionId: UUID): Map<Int, FormAnswer>
    suspend fun getSessionUnitScopedFormAnswers(sessionUnitId: UUID): Map<Int, FormAnswer>
