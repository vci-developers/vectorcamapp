...
class IntakeValidationUseCasesTest {
    ...
    @Test
    fun houseNumber_nonBlankValue_returnsSuccess() {
        val result = ValidateHouseNumberUseCase()("42A")
        assertTrue(result is Result.Success)
    }

    @Test
    fun houseNumber_blankValue_returnsError() {
    ...
    @Test
    fun llinType_nonBlankValue_returnsSuccess() {
        val result = ValidateLlinTypeUseCase()("Pyrethroid Only")
        assertTrue(result is Result.Success)
    }

    @Test
    fun llinType_blankValue_returnsError() {
    ...
    @Test
    fun llinBrand_nonBlankValue_returnsSuccess() {
        val result = ValidateLlinBrandUseCase()("OLYSET Net")
        assertTrue(result is Result.Success)
    }

    @Test
    fun llinBrand_blankValue_returnsError() {
    ...
    @Test
    fun collectionDate_pastDate_returnsSuccess() {
    ...
    @Test
    fun collectionDate_futureDate_returnsError() {
    ...
    @Test
    fun numPeopleInHouse_zero_returnsSuccess() {
        val result = ValidateNumPeopleSleptInHouseUseCase()(0)
        assertTrue(result is Result.Success)
    }

    @Test
    fun numPeopleInHouse_positive_returnsSuccess() {
        val result = ValidateNumPeopleSleptInHouseUseCase()(5)
        assertTrue(result is Result.Success)
    }

    @Test
    fun numPeopleInHouse_negativeOne_returnsError() {
    ...
    @Test
    fun numPeopleInHouse_veryNegative_returnsError() {
    ...
    @Test
    fun numPeopleUnderLlin_zero_returnsSuccess() {
        val result = ValidateNumPeopleSleptUnderLlinUseCase()(0)
        assertTrue(result is Result.Success)
    }

    @Test
    fun numPeopleUnderLlin_positive_returnsSuccess() {
        val result = ValidateNumPeopleSleptUnderLlinUseCase()(3)
        assertTrue(result is Result.Success)
    }

    @Test
    fun numPeopleUnderLlin_negativeOne_returnsError() {
    ...
    @Test
    fun numLlins_zero_returnsSuccess() {
        val result = ValidateNumLlinsAvailableUseCase()(0)
        assertTrue(result is Result.Success)
    }

    @Test
    fun numLlins_positive_returnsSuccess() {
        val result = ValidateNumLlinsAvailableUseCase()(10)
        assertTrue(result is Result.Success)
    }

    @Test
    fun numLlins_negativeOne_returnsError() {
    ...
    @Test
    fun monthsSinceIrs_zero_returnsSuccess() {
        val result = ValidateMonthsSinceIrsUseCase()(0)
        assertTrue(result is Result.Success)
    }

    @Test
    fun monthsSinceIrs_positive_returnsSuccess() {
        val result = ValidateMonthsSinceIrsUseCase()(6)
        assertTrue(result is Result.Success)
    }

    @Test
    fun monthsSinceIrs_negativeOne_returnsError() {
    ...
    @Test
    fun collectionMethod_standardMethod_returnsSuccess() {
    ...
    @Test
    fun collectionMethod_blank_returnsError() {
        val result = ValidateCollectionMethodUseCase()("")
        assertEquals(FormValidationError.BLANK_COLLECTION_METHOD, (result as Result.Error).error)
    }

    @Test
    fun collectionMethod_otherWithDescription_returnsSuccess() {
    ...
    @Test
    fun collectionMethod_otherWithNoDescription_returnsError() {
        val label = IntakeDropdownOptions.CollectionMethodOption.OTHER.label
    ...
    @Test
    fun collectionMethod_otherWithWhitespaceOnlyDescription_returnsError() {
        val label = IntakeDropdownOptions.CollectionMethodOption.OTHER.label
        val result = ValidateCollectionMethodUseCase()("$label   ")
        assertEquals(FormValidationError.BLANK_COLLECTION_METHOD, (result as Result.Error).error)
    }
    ...
    @Test
    fun specimenCondition_standardCondition_returnsSuccess() {
    ...
    @Test
    fun specimenCondition_blank_returnsError() {
        val result = ValidateSpecimenConditionUseCase()("")
        assertEquals(FormValidationError.BLANK_SPECIMEN_CONDITION, (result as Result.Error).error)
    }

    @Test
    fun specimenCondition_otherWithDescription_returnsSuccess() {
    ...
    @Test
    fun specimenCondition_otherWithNoDescription_returnsError() {
        val label = IntakeDropdownOptions.SpecimenConditionOption.OTHER.label
    ...
    @Test
    fun specimenCondition_otherWithWhitespaceOnlyDescription_returnsError() {
        val label = IntakeDropdownOptions.SpecimenConditionOption.OTHER.label
        val result = ValidateSpecimenConditionUseCase()("$label   ")
        assertEquals(FormValidationError.BLANK_SPECIMEN_CONDITION, (result as Result.Error).error)
    }
